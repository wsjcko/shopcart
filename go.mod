module github.com/wsjcko/shopcart
...
require (
	...
	github.com/asim/go-micro/plugins/wrapper/ratelimiter/uber/v4 v4.0.0-20220404185419-6dedee5d8c2c
...
replace github.com/wsjcko/shopcart => github.com/wsjcko/shopcart v1.0.0
